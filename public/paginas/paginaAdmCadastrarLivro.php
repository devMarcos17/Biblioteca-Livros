...
<div class="login-container">
    ...
    <form action="../controle/processarCadastrarLivro.php" method="post" enctype="multipart/form-data">
        ...
        <div class="input-group">
         ...
         <div class="input-group">
            <label>Preço</label>
            <input type="number" placeholder="" name="preco" required>
        </div>
          <div class="input-group">
            <label>Imagem</label>
        ...
        <input type="file" name="url_arquivo" required>
    </div>
