...
<div class="login-container">
    ...
    <form action="../controle/processarCadastrar.php" method="post">
        <div class="input-group">
            <label>Nome</label>
            <input type="text" placeholder="Ane Caroline" name="nome" required>
        </div>
        <div class="input-group">
            <label>Email</label>
    ...
    <div class="quote">
        "O maior ato de rebeldia contra o sistema é o aprendizado"
    </div>
